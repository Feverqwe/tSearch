var get_lang = function (lang) {
    var lang_arr_en = {
        ...
        optShowIcons: 'Hide icons trackers in search results',
        optHideZeroSeed: 'Hide hand without seeds',
        optHideLeech: 'Hide column "peers"',
        optHideSeed: 'Hide column "seeds"',
        optTeaserFilter: 'Hide teasers and trailers in search results',
        optAutoSetCat: 'To define a category automatically',
        optSubSelectEnable: 'Highlight search results',
        optNoBlankDlLink: 'Do not open a new page when you click on the download link ↓',
        ...
        optFilterPanelToLeft: 'Move the filter panel to the right',
        optGoogleAnalytics: 'Do not send statistics',
    ...
    var lang_arr_ru = {
        ...
        stp_span_10: 'Скрыть столбец пиров (скачивающих)',
        ...
        optShowIcons: 'Скрыть иконки трекеров в результатах поиска',
        optHideZeroSeed: 'Скрыть раздачи без сидов (раздающих)',
        optHideLeech: 'Скрыть столбец "пиры" (скачивающие)',
        optHideSeed: 'Скрыть столбец "сиды" (раздающих)',
        optTeaserFilter: 'Скрыть тизеры и трейлеры в результатах поиска',
        optAutoSetCat: 'Определять категорию автоматически',
        optSubSelectEnable: 'Подсвечивать результаты поиска',
        optNoBlankDlLink: 'Не открывать новую страницу при нажатии на ссылку скачать ↓',
        ...
        optFilterPanelToLeft: 'Переместить панель фильтров вправо',
        optGoogleAnalytics: 'Не отправлять статистику',
        optUseEnglishPosterName: 'Отображать названия на английском',
        optHideTopSearch: 'Скрыть Топ-40 поисковых запросов',
        optAllowFavoritesSync: 'Синхронизировать списка избранного',
