var get_lang = function(lang) {
    var lang_arr_en = {
        ...
        exp_imdb_in_cinima: 'IMDB: Now in the movie',
        exp_imdb_films: 'IMDB: Movies',
        exp_imdb_serials: 'IMDB: TV Series',
        ...
        time_f_s: ['For all the time', 'For an hour', 'For the day', 'For the week', 'For the month', 'For the year', 'For the period...', 'For the 3 day'],
    ...
    var lang_arr_ru = {
        ...
        exp_films: 'Фильмы',
        exp_serials: 'Сериалы',
        exp_imdb_in_cinima: 'IMDB: Сейчас в кино',
        exp_imdb_films: 'IMDB: Фильмы',
        exp_imdb_serials: 'IMDB: Сериалы',
        ...
        time_filter: 'Дата',
        time_f_s: ['За всё время', 'За час', 'За сутки', 'За неделю', 'За месяц', 'За год', 'За период...', 'За 3-е суток'],
