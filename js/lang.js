...
if (_lang == 'en')
    _lang = {
        ...
        stp_span_12 : 'Automatically move to the category when your choice movie\series etc on the main page',
        stp_span_13 : 'Do not show teasers\trailers in search results',
        stp_span_14 : 'Add a quick search in the address bar (written tms then press Tab)',
        stp_span_15 : 'Add search to the context menu (select text, right click - Search torrent)',
        stp_span_17 : 'Looking for a full match phrases (phrases can be more than one delimited by commas)',
        stp_span_18 : 'Seeking to match one of the words',
        stp_span_19 : 'Seeking a match of all the words you',
