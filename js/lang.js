var get_lang = function (lang) {
    var lang_arr_en = {
        ...
        ad: 'Ad',
        useEnglishPosterName: 'Show names movie\\series in English on the front page',
        allowGetDescription: 'Get a description of the search query from Google. (each request will be matched with google!)',
        enableFavoriteSync: 'Allow sync favorites list in the cloud',
    ...
    var lang_arr_ru = {
        ...
        ad: 'Реклама',
        useEnglishPosterName: 'Отображать имена фильмов\\сериалов на английском на главной странице',
        allowGetDescription: 'Получать описание поискового запроса из Google. (каждый запрос будет искаться в google!)',
        enableFavoriteSync: 'Разрешить синхронизацию списка избранного в облако',
