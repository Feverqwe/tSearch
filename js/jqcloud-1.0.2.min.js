(function($) {
    $.fn.jQCloud = function(word_array) {
        ...
        var min_top = Math.round(h / 2);
        var max_bottom = Math.round(h / 2);
        ...
        function write_line(line_num, ab, first) {
            for (var i = 0; i < l; i++) {
                ...
                if (table_arr[line_num] === undefined) {
                    table_arr[line_num] = {};
                    center = 1;
                }
                if (center) {
                ...
                if (i % 2) {
                    ...
                    for (var n = c_pos; n > -1; n--) {
                        if (table_arr[line_num][n] === undefined) {
                            if (start < 0) {
                    ...
                    if (start > -1 && end) {
                        ...
                        for (var n = start; n <= start + word_array[i]["width"]; n++) {
                            ...
                            var ftop = word_array[i]["height"] + top;
                            if (max_bottom < ftop) {
                                max_bottom = ftop;
                            }
                        }
        ...
        table_arr = null;
        word_array = null;
        this.css({"height": max_bottom + min_top, "margin-top": -min_top, "visibility": "visible"});
        return $this;
    };
})(jQuery);