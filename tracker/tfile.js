...
tracker[tmp_num] = function () {
    ...
    var filename = 'tfile';
    var id = null;
    var icon = 'http://tfile.ru/favicon.ico';
    ...
    var web = function () {
        ...
        var calculateCategory = function (n) {
            ...
            /* Спорт */[18,1061,19,1393,1278,272,284,1308,331,270,1281,1279,472,1236,343,173,332,273,268,269,1319,1318,1317,1316,1315,1314,1313]
            ];
        ...
        var readCode = function (c) {
            ...
            for (i = 1;i<l;i++) {
                ...
                arr[arr.length] = {
                    ...
                    //},
                    'category' : {
                        'title' : td.eq(0).children('a').eq(0).text(),
