...
const code = {
  ...
  "selectors": {
    ...
    "skipFromStart": 1,
    "skipFromEnd": 0,
    "title": {"selector": "td:eq(1)>a:eq(-1)", "pipeline": [{"name": "getText", "args": []}]},
    "url": {"selector": "td:eq(1)>a:eq(-1)", "pipeline": [{"name": "getProp", "args": ["href"]}]},
    "size": {"selector": "td:eq(-2)", "pipeline": [{"name": "getText", "args": []}, {"name": "parseSize", "args": []}]},
    "downloadUrl": {"selector": "td:eq(1)>a:eq(-2)", "pipeline": [{"name": "getProp", "args": ["href"]}]},
    "seeds": {
      "selector": "td:eq(-1)>span.green",
      "pipeline": [{"name": "getText", "args": []}, {"name": "toInt", "args": []}]
    },
    "peers": {
    ...
    "date": {
      "selector": "td:eq(0)",
      "pipeline": [{"name": "getText", "args": []}, {
        "name": "legacyReplaceMonth",
        "args": []
      }, {"name": "legacyParseDate", "args": ["1"]}]
    },
    "nextPageUrl": {"selector": "#index > table ~ b", "pipeline": []}
  },
  "description": {
    "icon": "data:image/x-icon;base64,",
    "name": "Рутор",
