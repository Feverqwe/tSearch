...
engine.trackerLib.piratbit = {
    ...
    desc: 'Крупнейший русскоязычный торрент трекер. фильмы, dvdrip, hdrip, 720p, 1080p, repack, сериалы, mp3...',
    flags: {
        auth: 1,
        language: 'ru',
        cyrillic: 1,
    ...
    categoryList: [
        ...
        /*Documen*/[1390, 79, 359, 348, 345, 342, 363, 361, 362, 818, 1362, 1361],
