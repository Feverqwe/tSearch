...
engine.trackerLib.rutor = {
    ...
    search: {
        ...
        listItemSplice: [1, 0],
        torrentSelector: {
            title: 'td:eq(1)>a:eq(-1)',
            url: {selector: 'td:eq(1)>a:eq(-1)', attr: 'href'},
            size: 'td:eq(-2)',
            downloadUrl: {selector: 'td:eq(1)>a:eq(-2)', attr: 'href'},
            seed: 'td:eq(-1)>span.green',
            peer: 'td:eq(-1)>span.red',
            date: 'td:eq(0)'
        },
        onGetValue: {
