...
engine.trackerLib.tfile = {
    ...
    search: {
        ...
        torrentSelector: {
            categoryTitle: 'td.f',
            categoryUrl: {selector: 'td.f>a:eq(0)', attr: 'href'},
            categoryId: {selector: 'td.f>a:eq(0)', attr: 'href'},
            title: 'td.t>a',
            url: {selector: 'td.t>a', attr: 'href'},
            size: 'td.dl:eq(0)>a',
            downloadUrl: {selector: 'td.dl:eq(0)>a', attr: 'href'},
            seed: 'td.dl:eq(1)',
            peer: 'td.dl:eq(2)',
            date: 'td:eq(-1)'
        },
