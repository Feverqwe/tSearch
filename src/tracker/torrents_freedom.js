...
engine.trackerLib['torrents.freedom'] = {
    ...
    categoryList: [
        ...
        /*Documen*/[13, 187, 188, 298, 299, 300, 297, 296, 190, 191, 295, 291, 619, 201, 15, 185, 184, 629, 183, 542, 714, 186, 630, 122, 304, 14, 215, 214, 213, 212, 211, 210, 123],
    ...
    search: {
        ...
        onGetValue: {
            ...
            date: function(value) {
                "use strict";
                var time = this.tracker.env.el.find('td:eq(11)>p:eq(1)').text();
                value += ' ' + time;
